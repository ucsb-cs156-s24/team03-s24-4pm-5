    ...
    // Tests for GET /api/RecommendationRequest/all
        ...
        public void an_admin_user_can_post_a_new_recommendationrequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/RecommendationRequest/post?requesterEmail=cgaucho@ucsb.edu&professorEmail=phtcon@ucsb.edu&explanation=BS/MS Program&dateRequested=2022-01-03T00:00:00&dateNeeded=2022-01-04T00:00:00&done=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_recommendationrequest() throws Exception {
                ...
                RecommendationRequest recommendationRequestEdited = RecommendationRequest.builder()
                                .requesterEmail("jasontnguyen@ucsb.edu")
