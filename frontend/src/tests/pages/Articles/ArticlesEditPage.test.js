    ...
    describe("tests where backend is working normally", () => {
        ...
        beforeEach(() => {
            ...
            axiosMock.onPut('/api/Articles').reply(200, {
                ...
                url: "editedTestUrl",
                explanation: "editedTestExplanation",
                email: "editedTestEmail",
                dateAdded: "3022-02-02T00:00"
            });
        });
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(urlField, { target: { value: 'editedTestUrl' } });
            fireEvent.change(explanationField, { target: { value: 'editedTestExplanation' } });
            fireEvent.change(emailField, { target: { value: 'editedTestEmail' } });
            fireEvent.change(dateAddedField, { target: { value: '3022-02-02T00:00' } });

            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("Article Updated - id: 17 title: editedTestTitle");
