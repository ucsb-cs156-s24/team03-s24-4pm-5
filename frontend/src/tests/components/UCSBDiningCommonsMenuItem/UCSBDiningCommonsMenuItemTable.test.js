...
describe("RestaurantTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <UCSBDiningCommonsMenuItemTable UCSBDiningCommonsMenuItem={ucsbDiningCommonsMenuItemFixtures.threeMenuItems} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
    );
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-diningCommonsCode`)).toHaveTextContent("DLG");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-station`)).toHaveTextContent("Entrees");
